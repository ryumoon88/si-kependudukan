                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ Auth::user()->citizen->id_number }}</div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label ">Full Name</div>
                                    <div class="col-lg-9 col-md-8">{{ Auth::user()->get_name() }}</div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ Auth::user()->citizen->address }}</div>
                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input disabled type="text" class="form-control"
                                                value="{{ Auth::user()->citizen->id_number }}">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-4 col-lg-5">
                                            <input type="text" disabled class="form-control mb-2 mb-md-0 disabled"
                                                ...
                                                value="{{ old('first_name', Auth::user()->citizen->first_name) }}">
                                        </div>
                                        <div class="col-md-4 col-lg-4">
                                            <input disabled type="text" class="form-control disabled" id="last_name"
                                                placeholder="Last Name"
                                                value="{{ old('last_name', Auth::user()->citizen->last_name) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input disabled type="text" class="form-control" id="address"
                                                value="{{ Auth::user()->citizen->address }}">
                                        </div>
                                    </div>
