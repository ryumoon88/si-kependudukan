...
<section id="hero" class="d-flex flex-column justify-content-end align-items-center">
    <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
            ...
            <div class="carousel-container">
                <div class="col-lg-7 mb-0 d-flex align-items-center">
                    <div class="text-align-left align-self-center">
                        <h2 class="animate__animated animate__fadeInDown text-info">Selamat Datang Di Sistem
                            Informasi Administrasi Kependudukan</h2>
                    </div>
                </div>
        ...
        <div class="carousel-item">
            <div class="carousel-container">
                <div class="col-lg-6 mb-0 d-flex align-items-center">
                    <div class="text-align-left align-self-center">
                        <h2 class="animate__animated animate__fadeInDown text-info">Layanan Sistem Informasi
                            Administrasi Kependudukan</h2>
                    </div>
                </div>
        ...
        <div class="carousel-item">
            <div class="carousel-container">
                <h2 class="animate__animated animate__fadeInDown text-info">Berita & Artikel</h2>
                <p class="animate__animated animate__fadeInUp">Ut velit est quam dolor ad a aliquid qui aliquid.
                    Sequi ea ut et est quaerat sequi nihil ut aliquam. Occaecati alias dolorem mollitia ut.
                    Similique ea voluptatem. Esse doloremque accusamus repellendus deleniti vel. Minus et tempore
                    modi architecto.</p>
